...
namespace AwesomeTomatoes.DAL.Migrations
{
    ...
    [Migration("20220512155149_AddMovieBlob")]
    partial class AddMovieBlob
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AwesomeTomatoes.BLL.Models.Movie", b =>
                {
                    ...
                    b.HasIndex("MovieBlobId");

                    b.ToTable("Movies");
                });

            modelBuilder.Entity("AwesomeTomatoes.BLL.Models.MovieBlob", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AwesomeTomatoes.BLL.Models.Movie", b =>
                {
                    b.HasOne("AwesomeTomatoes.BLL.Models.MovieBlob", "MovieBlob")
                        .WithMany()
                        .HasForeignKey("MovieBlobId");

                    b.Navigation("MovieBlob");
                });
